...
@section('container-content')
                ...
                <div class="col-3 col-lg-4 col-md-6">
                    <div class="card mb-4">
                        ...
                        <button type="button"
                            ...
                            data-bs-toggle="modal" data-bs-target="#ModalMahasiswaAktifSudahKRS"><i
            ...
            @foreach ($TotalMahasiswaBelumKRS as $mhsBelumKRS)
                <div class="col-3 col-lg-4 col-md-6">
                    <div class="card mb-4">
                        ...
                        <button type="button"
                            style="position: absolute;bottom: 5px;right: 5px;border: 0px;background: transparent;"
                            data-bs-toggle="modal" data-bs-target="#ModalMahasiswaAktifBelumKRS"><i
                                class="bi bi-box-arrow-down-right"></i></button>
                    </div>
                </div>
            @endforeach
    ...
    <div class="modal fade" id="ModalMahasiswaAktifSudahKRS" tabindex="-1"
        aria-labelledby="ModalMahasiswaAktifSudahKRSLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="ModalMahasiswaAktifBelumKRS" tabindex="-1"
        aria-labelledby="ModalMahasiswaAktifBelumKRSLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
