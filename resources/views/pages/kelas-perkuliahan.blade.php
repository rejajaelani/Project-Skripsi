...
@section('container-content')
                    ...
                    <div class="col-3 col-lg-4 col-md-6">
                        <div class="card mb-4">
                            ...
                            <button type="button"
                                ...
                                data-bs-toggle="modal" data-bs-target="#ModalKelasPerprodi{{ $index1 }}"><i
    ...
    @foreach ($ListTotalKelasPerkuliahanPerProdi as $prodi)
        ...
        <div class="modal fade" id="ModalKelasPerprodi{{ $index2 }}" tabindex="-1"
            aria-labelledby="ModalKelasPerprodi{{ $index2 }}Label" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="ModalKelasPerprodi{{ $index2 }}Label">List Kelas Prodi
                            ({{ $prodi->NamaProdi }})
                        </h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <table class="table table-bordered table-striped table-sm"
                            id="tableListKelasPerkuliahan{{ $index2 }}">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama Mata Kuliah</th>
